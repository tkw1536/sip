  ...
  test.each([
    {
      ...
      filename: undefined,
      extension: undefined,
      expectedFilename: 'export',
    },
    {
      blob: new Blob(['hello world'], { type: 'text/plain' }),
      filename: undefined,
      extension: 'txt',
      expectedFilename: 'export.txt',
    },
    {
      blob: new Blob(['hello world'], { type: 'text/plain' }),
      filename: 'myfile',
      extension: undefined,
      expectedFilename: 'myfile',
    },
    {
      blob: new Blob(['hello world'], { type: 'text/plain' }),
      filename: 'myfile.txt',
    ...
    'download($blob, $filename, $extension) -> $expectedFilename',
    ({ blob, filename, extension, expectedFilename }) => {
